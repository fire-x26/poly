...
export interface OptionProxyInterface extends Interface {
  getFunction(
...
export interface OptionProxy extends BaseContract {
  connect(runner?: ContractRunner | null): OptionProxy;
  waitForDeployment(): Promise<this>;

  interface: OptionProxyInterface;
