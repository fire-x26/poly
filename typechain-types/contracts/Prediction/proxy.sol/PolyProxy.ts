...
export interface PolyProxyInterface extends Interface {
  getFunction(
...
export interface PolyProxy extends BaseContract {
  connect(runner?: ContractRunner | null): PolyProxy;
  waitForDeployment(): Promise<this>;

  interface: PolyProxyInterface;
