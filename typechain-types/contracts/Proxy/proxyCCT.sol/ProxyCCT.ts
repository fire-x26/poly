...
export interface ProxyCCTInterface extends Interface {
  getFunction(
...
export interface ProxyCCT extends BaseContract {
  connect(runner?: ContractRunner | null): ProxyCCT;
  waitForDeployment(): Promise<this>;

  interface: ProxyCCTInterface;
