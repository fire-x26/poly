...
export interface ProxyPCCInterface extends Interface {
  getFunction(
...
export interface ProxyPCC extends BaseContract {
  connect(runner?: ContractRunner | null): ProxyPCC;
  waitForDeployment(): Promise<this>;

  interface: ProxyPCCInterface;
