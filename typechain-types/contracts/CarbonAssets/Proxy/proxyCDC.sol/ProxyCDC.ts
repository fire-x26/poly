...
export interface ProxyCDCInterface extends Interface {
  getFunction(
...
export interface ProxyCDC extends BaseContract {
  connect(runner?: ContractRunner | null): ProxyCDC;
  waitForDeployment(): Promise<this>;

  interface: ProxyCDCInterface;
