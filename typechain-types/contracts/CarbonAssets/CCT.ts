...
export interface CCTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "Version"
      | "_CDC"
...
export interface CCT extends BaseContract {
  connect(runner?: ContractRunner | null): CCT;
  waitForDeployment(): Promise<this>;

  interface: CCTInterface;
  ...
  setAuthedContractAddress: TypedContractMethod<
    [_cdc: AddressLike, _pcc: AddressLike],
    [void],
    "nonpayable"
  >;
